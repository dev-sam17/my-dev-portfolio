...
const freelanceProjects: FreelanceProject[] = [
  {
    ...
    description: "Redesigned and implemented a customer portal with improved UX, resulting in 40% increase in user engagement and 25% reduction in support tickets.",
  ...
  },
  {
    ...
    description: "Developed a secure patient management system with appointment scheduling, medical records, and billing integration.",
  ...
  },
  {
    ...
    description: "Built an interactive learning dashboard with real-time progress tracking, quiz functionality, and content recommendation engine.",
  ...
  },
  {
    ...
    description: "Created a responsive investment portfolio tracker with real-time market data integration, performance analytics, and custom alerts.",
...
export function FreelanceSection() {
  ...
  return (
    <div className="container h-full w-full bg-neutral-50 dark:bg-slate-900 py-16">
      <div className="space-y-12">
        <div className="text-center space-y-4">
          <h2 className="text-4xl font-bold dark:text-white text-black">Freelance Work</h2>
          <p className="text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
            Selected client projects where I delivered high-quality solutions that helped businesses achieve their goals.
          </p>
        </div>
            ...
            {freelanceProjects.map((project, index) => (
              ...
              >
                ...
                <div className={`md:grid md:grid-cols-2 md:gap-8 ${index % 2 === 0 ? '' : 'md:flex-row-reverse'}`}>
                  ...
                  <div className={`${index % 2 === 0 ? 'md:block' : 'md:order-2'} hidden md:block`}>
                    {index % 2 === 0 ? (
                    ...
                    >
                      <Card className="overflow-hidden border border-neutral-200 dark:border-neutral-800 p-6 relative">
                        ...
                        <div className="space-y-4">
                          <div>
                            <h3 className="text-xl font-bold dark:text-white">{project.projectName}</h3>
