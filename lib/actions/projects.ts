...
export async function createProject(project: ProjectForm): Promise<Project | { error: string }> {
  try {
...
export async function getProjectById(id: string): Promise<Project | null | { error: string }> {
  try {
...
export async function deleteProject(id: string): Promise<Project | { error: string }> {
  try {
