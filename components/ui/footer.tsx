      ...
      <div className="container mx-auto px-4">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              <li className="text-gray-600 dark:text-gray-300">
                <span className="font-medium">Email:</span> codewizard.saurav@gmail.com
              </li>
              <li className="text-gray-600 dark:text-gray-300">
        ...
        <div className="mt-12 pt-6 border-t border-neutral-200 dark:border-neutral-800 text-center">
          ...
          <p className="text-xs text-gray-500 dark:text-gray-500 mt-1 flex items-center justify-center">
            Made with <IconHeart size={14} className="mx-1 text-red-500" /> using Next.js and Tailwind CSS
          </p>
        </div>
      </div>
    </footer>
